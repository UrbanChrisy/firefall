...
public class LoadResultTransaction<T extends HasId> {
    ...
    public LoadResultTransaction(Transaction transaction, DocumentReference reference, com.google.cloud.firestore.Query query, Class<T> entityClass) {
        this.query = query;
